...
function lud_enqueue_assets() {
    wp_enqueue_style( 'lud-main-style', LUD_PLUGIN_URL . 'assets/css/lud-style.css', array(), '1.5.4' );
}
...
function lud_admin_enqueue_assets() {
    wp_enqueue_style( 'lud-admin-style', LUD_PLUGIN_URL . 'assets/css/lud-style.css', array(), '1.5.4' );
}
